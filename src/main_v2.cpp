...
int main() {
    ...
    try {
        ...
        logger.log("使用产能驱动生成器v2.0生成需求数据...");

        // 构建需求生成配置对象
        DemandGenConfigV2 demand_config;
        demand_config.U = U;
        demand_config.I = I;
        demand_config.T = T;
        ...
        // 调用v2生成器生成需求数据
        gc.demand = DemandGeneratorV2::Generate(demand_config);
